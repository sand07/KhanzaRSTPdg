...
//    private SimpleDateFormat tanggalNow = new SimpleDateFormat("dd-MM-yyyy");
    ...
    private void initComponents() {
        ...
        BtnTidakValidasi = new widget.Button();
        ...
        BtnTidakValidasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/101.png"))); // NOI18N
        BtnTidakValidasi.setMnemonic('S');
        BtnTidakValidasi.setText("Tidak Validasi");
        BtnTidakValidasi.setToolTipText("Alt+S");
        BtnTidakValidasi.setName("BtnTidakValidasi"); // NOI18N
        BtnTidakValidasi.setPreferredSize(new java.awt.Dimension(130, 30));
        BtnTidakValidasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnTidakValidasiActionPerformed(evt);
            }
        });
        BtnTidakValidasi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnTidakValidasiKeyPressed(evt);
            }
        });
        panelGlass8.add(BtnTidakValidasi);
        ...
        jLabel70.setBounds(790, 160, 70, 23);
        ...
        Konfirmasi.setBounds(1060, 220, 72, 20);
        ...
        internalFrame1.getAccessibleContext().setAccessibleName(".::[ Validasi SBAR Rawat Jalan ]::.");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("validasi_pemeriksaan_sbar_ralan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",15,new String[]{
...
//        }
    ...
    private void BtnTidakValidasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTidakValidasiActionPerformed
        if(TNoRw.getText().isEmpty()||TNoRM.getText().isEmpty()||TPasien.getText().isEmpty()){
            ...
            if(Sequel.menyimpantf("validasi_pemeriksaan_sbar","?,?,?,?,?,?,?","No.Rawat",7,new String[]{
                TNoRw.getText(),TanggalPemeriksaan.getText(),JamPemeriksaan.getText(),KodeDokter.getText(),tanggalNow.format(new Date()),jamNow.format(new Date()),"Tidak Di Validasi",
            })==true){
                tampil();
                emptTeks();
            }
        }
    }//GEN-LAST:event_BtnTidakValidasiActionPerformed

    private void BtnTidakValidasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnTidakValidasiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnTidakValidasiKeyPressed
    ...
    */
    ...
    private widget.Button BtnTidakValidasi;
