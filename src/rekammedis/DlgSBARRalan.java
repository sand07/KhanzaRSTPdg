                        ...
                        if(rs2.next()){
                            ...
                            while(rs2.next()){
                                ...
                                if(Sequel.cariInteger("select count(validasi_pemeriksaan_sbar_ralan.nik_validator) " +
                                    ...
                                    gbrverif="<img src ='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/images/verif.png' align='center' width='70' height='70'/";
                                }else{
                                    gbrverif="<img src ='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/images/notverif.png' align='center' width='70' height='70'/";
                                }
