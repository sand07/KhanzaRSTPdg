 ...
 * @author dosen
 */
public final class DlgCariDiagnosa extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariDiagnosa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariDiagnosa dialog = new DlgCariDiagnosa(new javax.swing.JFrame(), true);
