...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    public DlgKasirRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabModekasir=new DefaultTableModel(null,new String[]{
            ...
            "Biaya Reg","Jenis Bayar | No. SEP","Status","No.Rawat","Tanggal",
    ...
    private void initComponents() {
        ...
        MnSttsFinger = new javax.swing.JMenuItem();
        ...
        MnSttsFinger.setBackground(new java.awt.Color(255, 255, 254));
        MnSttsFinger.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSttsFinger.setForeground(new java.awt.Color(50, 50, 50));
        MnSttsFinger.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnSttsFinger.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnSttsFinger.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnSttsFinger.setLabel("Sudah Finger");
        MnSttsFinger.setName("MnSttsFinger"); // NOI18N
        MnSttsFinger.setPreferredSize(new java.awt.Dimension(180, 26));
        MnSttsFinger.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnSttsFingerBtnPrintActionPerformed(evt);
            }
        });
        MnStatus.add(MnSttsFinger);
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-01-2024" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-01-2024" }));
        ...
        BtnKetWarna3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/reviews.png"))); // NOI18N
        BtnKetWarna3.setMnemonic('K');
        BtnKetWarna3.setText("Review SEP, Resep & Penunjang");
        BtnKetWarna3.setToolTipText("");
        BtnKetWarna3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        cmbStatus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua", "Belum", "Sudah", "Batal", "Berkas Diterima", "Dirujuk", "Meninggal", "Dirawat", "Pulang Paksa", "Sudah Finger" }));
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void MnSttsFingerBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSttsFingerBtnPrintActionPerformed
         if(TNoRw.getText().trim().equals("")){
            Valid.textKosong(TNoRw,"No.Rawat");
        }else{
            if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                ...
                Valid.editTable(tabModekasir,"reg_periksa","no_rawat",TNoRw,"stts='Sudah Finger'");
                if(tbKasirRalan.getSelectedRow()>-1){
                    tabModekasir.setValueAt("Sudah Finger",tbKasirRalan.getSelectedRow(),10);
                }
            }

        }
    }//GEN-LAST:event_MnSttsFingerBtnPrintActionPerformed
    ...
    private void BtnTambahTindakanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahTindakanActionPerformed
        if(TNoRMCari.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgCatatanAlergi catatan1=new DlgCatatanAlergi(null,true);
            catatan1.setNoRm(TNoRMCari.getText());
            catatan1.setSize(720,330);
            catatan1.setLocationRelativeTo(internalFrame1);
            catatan1.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_BtnTambahTindakanActionPerformed

    private void BtnKetWarna3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKetWarna3ActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    }//GEN-LAST:event_BtnKetWarna3ActionPerformed

    private void BtnKetWarna3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKetWarna3KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnKetWarna3KeyPressed
    ...
    */
    ...
    private javax.swing.JMenuItem MnSttsFinger;
    ...
    //private javax.swing.JMenuItem MnHasilPemeriksaanUSG;
    private javax.swing.JMenuItem MnHasilPemeriksaanUSGUrologi;
    private javax.swing.JMenuItem MnHasilPemeriksaanUSGGynecologi;
    private javax.swing.JMenuItem MnHasilPemeriksaanEKG;
    ...
    private void tampilkasir() {     
        ...
        try{   
            ...
            pskasir=koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                "reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"+
                "reg_periksa.p_jawab,reg_periksa.almt_pj,reg_periksa.hubunganpj,reg_periksa.biaya_reg,reg_periksa.stts,if(bridging_sep.no_sep is null,penjab.png_jawab,concat(penjab.png_jawab,'-',bridging_sep.no_sep)) as png_jawab,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur, "+
                "reg_periksa.status_bayar,reg_periksa.status_poli,reg_periksa.kd_pj,reg_periksa.kd_poli,pasien.no_tlp "+
                "from reg_periksa "+
                ...
                "left join bridging_sep on bridging_sep.no_rawat=reg_periksa.no_rawat "+
                    //Tidak munculkan No SEP RANAP//
                "and bridging_sep.jnspelayanan NOT IN ('1')"+
                    //AKHIR//
                "where  "+
