...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnSudahFinger = new javax.swing.JMenuItem();
        ...
        MnSudahFinger.setBackground(new java.awt.Color(255, 255, 254));
        MnSudahFinger.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSudahFinger.setForeground(new java.awt.Color(50, 50, 50));
        MnSudahFinger.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnSudahFinger.setText("Sudah Finger");
        MnSudahFinger.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnSudahFinger.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnSudahFinger.setName("MnSudahFinger"); // NOI18N
        MnSudahFinger.setPreferredSize(new java.awt.Dimension(180, 26));
        MnSudahFinger.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnSudahFingerBtnPrintActionPerformed(evt);
            }
        });
        MnStatus.add(MnSudahFinger);
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void MnSudahFingerBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSudahFingerBtnPrintActionPerformed
       if(TNoRw.getText().trim().equals("")){
            Valid.textKosong(TNoRw,"No.Rawat");
        }else{
            if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
    ...
    }//GEN-LAST:event_MnSudahFingerBtnPrintActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnSudahFinger;
